...
#[\AllowDynamicProperties]
  ...
  class View {
    ...
    public function render($viewName) {
      ...
      if(file_exists(FILES_ROOT . DS . 'app' . DS . 'views' . DS . $viewString . '.php')) {
        include(FILES_ROOT . DS . 'app' . DS . 'views' . DS . $viewString . '.php');
        include(FILES_ROOT . DS . 'app' . DS . 'views' . DS . 'layouts' . DS . $this->_layout . '.php');
      } else {
    ...
    public function insert($path){
      include FILES_ROOT . DS . 'app' . DS . 'views' . DS . $path . '.php';
     }
    ...
    public function partial($group, $partial){
      include FILES_ROOT . DS . 'app' . DS . 'views' . DS . $group . DS . 'partials' . DS . $partial . '.php';
    }
